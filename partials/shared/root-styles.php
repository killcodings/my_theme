...
$position_buttons = get_field( 'center', 'options' );
$position_buttons = isset( $position_buttons[0] ) ? $position_buttons[0] : 'unset';
?>
<style>
    :root {
        --offsets: 64px;
        ...
        --buttons-border-radius: <?= $buttons_setup['border_radius'] . 'px' ?: '' ?>;
