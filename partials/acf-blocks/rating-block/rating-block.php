...
$buttons_main_setting = [
	'buttons'        => $rating_fields_buttons['add_buttons'],
	'buttons_color'  => $rating_fields_buttons['buttons_color'],
	'columns'        => $rating_fields_buttons['columns'] ?? '1',
	'position_image' => $rating_fields_buttons['position_image_buttons']
];

acf_block_before( 'Блок рейтинг', $is_preview );
?>
    <div class="rating-block" style="background:<?= $background_rating_block ?>">
        <InnerBlocks/>
		<?php
